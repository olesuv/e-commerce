import { IOrderCategoryProps } from "../../../../types/orderDetailsLandingProps";

export default function OrderCategory(props: IOrderCategoryProps) {
  return (
    <ul className="flex flex-wrap *:my-1 *:mr-1 *:rounded-full *:border *:px-2 *:py-0.5 *:text-xs">
      {props?.orderCategory.map((category: string) => {
        switch (category) {
          case "Electronics":
            return (
              <li
